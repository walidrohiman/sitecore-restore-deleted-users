<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeletedUsers.aspx.cs" Inherits="SitecoreExtension.RestoreDeletedUsers.Control.DeletedUsers" %>
...
<head runat="server">
  ...
  <script type="text/javascript">
    ...
    function Users_onDoubleClick(sender, eventArgs) {
      scForm.postRequest("", "", "", "usermanager:restore");
    }
...
<body style="height: 100%;" id="PageBody" runat="server">
  <form id="DeletedUsersForm" runat="server">
	...
	<div class="scFormDialogHeader">
	  <div class="DialogHeader">
		<sc:Literal Text="Deleted Users" runat="server" />
	  </div>
	  <div class="DialogHeaderDescription">
		<sc:Literal Text="Restore or Delete Permanently" runat="server" />
	  </div>
